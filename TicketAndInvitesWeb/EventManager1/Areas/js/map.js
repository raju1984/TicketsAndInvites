            ...
            if (status == google.maps.GeocoderStatus.OK && results[0]) {
                ...
                for (var i = 0; i < results[0].address_components.length; i++) {
                    ...
                    if (results[0].address_components[i].types[0] == "political" && results[0].address_components[i].types[2] == "sublocality_level_2") {
                        ...
                        //console.log("AddressLine == "+region.long_name);
                    }
                ...
                var strArray = results[0].formatted_address;
                var entryArray = strArray.split(",");
                var a = entryArray.slice(-1)[0] 

                if (a) {
                    var dd = document.getElementById('CountryId');
                    for (var i = 0; i < dd.options.length; i++) {
                        if (dd.options[i].text == a.trim()) {
                            dd.selectedIndex = i;
                            break;
                        }
                    }
                ...
                console.log("countrynames == " + entryArray);
                $("#spnaddress").text(results[0].formatted_address);
                $("#AddressLine").val(results[0].formatted_address);
