	...
	var Video = {
				...
				template = $(
								...
								'<div class="vid-info-layer">'+
									'<div class="vid-info-wrapper flex align-end">'+
										'<div class="main-info">'+
											'<p id="msgplay" >Your video will start shortly, depending on your internet connection it may take a while to start.</p>'+ /*You\'re watching*/
											'<h2>'+base.options.video.title+'</h2>'+
										'</div>'+
        ...
        decodeMedia: function (el) {
            ...
            media.onwaiting = function () {
                //$("msgplay").css("display","block")
				// while video is waiting to load the next frame  style="display:none"
			};
